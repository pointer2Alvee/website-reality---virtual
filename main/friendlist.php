              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text" style="color:lawngreen"><?php echo $row["area"] ?></p>
                    <p class="card-text d-flex justify-content-between align-items-center">
                      <small class="text-muted">Last active <?php echo $row["lastActive"] ?> mins ago</small>
                      <small style="color:brown; text-align:right">Rep:<?php echo $row["reputation"] ?></small>
                    </p>
                  </div>
                </div>
              </div>
